...
public class DownloadScreen extends Screen {
    ...
    public DownloadScreen(Screen scr) {
        super(Text.translatable("Download Skin"));
        parent = scr;
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget((int)(this.width / 2 - 50), 50, 100, 20, Text.translatable("Download"), button -> {
        ...
        //download text field
        this.downloadField = new TextFieldWidget(this.font, (this.width/2 - 150), 20, 300, 20, this.downloadField, Text.translatable("Username"));
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, font, I18n.translate("username"), this.width/2, 5, 0xFFFFFF);
    ...
    public boolean download(String username) {
        try {
            ...
            error = (I18n.translate("No Internet"));
            return false;
        }
        catch(Exception e) {
            error = (I18n.translate("Invalid Username"));
            return false;
        }
    }
